...
(function () {
    ...
    const AuthUI = {
        ...
        openModal() {
            ...
            if (modal) {
                ...
                // إعادة تعيين الحالة إلى وضع تسجيل الدخول
                isSignUpMode = false;
                isPhoneSignUp = false;
                this.renderView();
                this.clearErrors();
        ...
        handleLogin: async function () {
            ...
            // تحديد إذا كان الإدخال بريد إلكتروني أم رقم هاتف
            ...
            try {
                ...
                if (isEmail) {
                    ...
                    // تسجيل الدخول بالهاتف (نفترض أنه رقم هاتف مع رمز البلد)
                    // ملاحظة: تسجيل الدخول بالهاتف يتطلب OTP، لكننا سنستخدمه كبريد إلكتروني مؤقتاً
                    // يمكن تعديل هذا لاستخدام OTP إذا رغبت
                    this.showError('Connexion par téléphone non encore supportée. Utilisez votre email.');
    ...
    console.log('authUI.js loaded successfully with new design');
})();
